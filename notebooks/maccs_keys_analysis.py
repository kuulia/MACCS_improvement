...
nz_keys.to_csv('../maccs_improvement/reports/nz_keys.csv')
################################################################################
...
unused_keys.to_csv('../maccs_improvement/reports/unused_keys.csv')
feature_counts.to_csv('../maccs_improvement/reports/feature_counts.csv')
...
low_usage_keys.to_csv('../maccs_improvement/reports/low_usage_keys.csv')

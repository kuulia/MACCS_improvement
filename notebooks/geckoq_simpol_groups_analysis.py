...
raw_data = pd.read_csv('../maccs_improvement/data/output/geckoq_simpol_all_groups.csv')
...
data.to_csv('../maccs_improvement/data/output/mins_and_maxes_geckoq.csv')
print(data)
...
pruned_data.to_csv('../maccs_improvement/data/output/potential_simpol_groups_geckoq.csv')

further_pruned_data = data[ data['Max'] > 1 ]
further_pruned_data.to_csv('../maccs_improvement/data/output/multiple_simpol_groups_geckoq.csv')
print(f'\n{further_pruned_data}')
...
more_than_four.to_csv('../maccs_improvement/data/output/more_than_four_simpol_groups_geckoq.csv')